...
from proyecto.views import Gestionar_proyectoView, Crear_proyectoView, ListadoProyectosView, DeshabilitarProyectoView, \
    ...
    ActualizarEstadoProyectoView, ModificarProyectoView, ActualizarCalendarioEstadoProyectoView, ProyectoPDFView, \
    FacturaProyectoPDFView
...
urlpatterns = [
    ...
    path('proyectos/descargar/<int:proyecto_id>/', ProyectoPDFView.as_view(), name='descargar_proyect'),
    path('proyectos/descargarfactura/<int:proyecto_id>/', FacturaProyectoPDFView.as_view(), name='descargar_factura'),
    ...
    path('proyectos/listado-proyecto/actualizar_calendario_estado_proyecto/<int:pk>/', ActualizarCalendarioEstadoProyectoView.as_view(), name='actualizar_calendario_estado_proyecto'),
