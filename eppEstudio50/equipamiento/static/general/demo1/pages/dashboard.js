...
var KTDashboard = function() {
        ...
        var config = {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointBorderColor: Chart.helpe3rs.color('#000000').alpha(0).rgbString(),
    ...
    let kt_chart = $('#kt_chart_revenue_change'),
        rojo = kt_chart.data('rojo'),
        amarillo = kt_chart.data('amarillo'),
        verde = kt_chart.data('verde');
    console.log(rojo)
    console.log(amarillo)
    console.log(rojo)
    var revenueChange = function() {
        if (kt_chart.length === 0) {
            return;
        }
